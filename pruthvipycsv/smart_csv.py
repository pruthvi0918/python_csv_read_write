...
class Smartcsv:
    ...
    def process_csv_files(self):
        ...
        print("Statrted reading csv files")
        ...
        if(not data_file_path_obj.exists()):
            ...
            print(f"Started processing the {data_file_path_obj}  file")
            print(
    ...
    def get_data_file_path(self):
        ...
        # print(f"Current folder : {thisfolder}")
        # print(initfile)
        config = configparser.ConfigParser()
        config.read(initfile)
        test_file_data_path = config.get(
            'FilePath-info', 'test_file_data_path')
        print(f" Reading test data from this location : {test_file_data_path}")
    ...
    def get_csv_files(self, path_obj):
        ...
        with ZipFile(path_obj) as zip_obj:
            ...
            print(path_of_extracted_data.is_dir())
            csv_files = [
